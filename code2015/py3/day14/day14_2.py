...
for i in range(seconds):    
    ...
    [rd.giveScore() for rd in raindeer if rd.distance == sorted(raindeer, key = lambda a : a.distance, reverse = True)[0].distance]
        
raindeer.sort(key = lambda a : a.score, reverse = True)
print (raindeer[0].score)
