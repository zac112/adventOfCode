...
def countBags(adjacency, start):
    bags = 1
    for i, dist in adjacency[start]:        
        bags += dist*countBags(adjacency, i)

    return bags

count = 0
path = []
bags = countBags(adjacency, "shiny gold")
print(bags-1) #original shiny gold not included
